...
/*--------------------------------------------------------------------------*/
  ...
  public void Write (string filename) {
	...
	void ProcDecl() {
		int parameters=0; string returntypestring="";  string name1; TastierType returntype = TastierType.Undefined; string name; string label; Scope currentScope = openScopes.Peek(); int enterInstLocation = 0; bool external = false; 
		Expect(9);
		if (la.kind == 10) {
			Get();
...
public class Errors {
	...
	public virtual void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 59: s = "invalid SimpleAssignment"; break;
