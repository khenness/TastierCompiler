...
/*--------------------------------------------------------------------------*/
  ...
  public void Write (string filename) {
	...
	static readonly bool[,] set = {
		...
		{x,T,x,x, x,x,x,x, x,T,x,x, T,x,x,x, x,x,x,T, x,T,T,T, x,T,T,x, x,x,x,x},
		{x,T,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,T, x,T,T,T, x,x,x,x, x,x,x,x},
		{x,T,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,T, x,T,T,T, x,T,T,x, x,x,x,x},
		{x,x,x,x, x,x,x,x, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,x, T,x,x,x}
...
public class Errors {
	...
	public virtual void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 37: s = "invalid ExternDecl"; break;
